...
import { OMNIDEF } from './appFraudExternalClientEnglish_def.js';
import tmpl from './appFraudExternalClientEnglish.html';
import tmpl_nds from './appFraudExternalClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudExternalClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
