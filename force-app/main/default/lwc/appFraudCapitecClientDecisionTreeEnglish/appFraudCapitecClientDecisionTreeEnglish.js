...
import { OMNIDEF } from './appFraudCapitecClientDecisionTreeEnglish_def.js';
import tmpl from './appFraudCapitecClientDecisionTreeEnglish.html';
import tmpl_nds from './appFraudCapitecClientDecisionTreeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudCapitecClientDecisionTreeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
