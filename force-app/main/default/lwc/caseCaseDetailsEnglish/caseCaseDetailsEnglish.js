...
import { OMNIDEF } from './caseCaseDetailsEnglish_def.js';
import tmpl from './caseCaseDetailsEnglish.html';
import tmpl_nds from './caseCaseDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCaseDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
