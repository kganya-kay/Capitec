...
import { OMNIDEF } from './caseStartCaseEnglish_def.js';
import tmpl from './caseStartCaseEnglish.html';
import tmpl_nds from './caseStartCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseStartCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
