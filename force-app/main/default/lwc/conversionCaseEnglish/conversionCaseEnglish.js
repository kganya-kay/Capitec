...
import { OMNIDEF } from './conversionCaseEnglish_def.js';
import tmpl from './conversionCaseEnglish.html';
import tmpl_nds from './conversionCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class conversionCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
