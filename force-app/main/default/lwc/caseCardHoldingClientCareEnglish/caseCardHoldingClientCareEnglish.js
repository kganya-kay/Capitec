...
import { OMNIDEF } from './caseCardHoldingClientCareEnglish_def.js';
import tmpl from './caseCardHoldingClientCareEnglish.html';
import tmpl_nds from './caseCardHoldingClientCareEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCardHoldingClientCareEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
