...
import { OMNIDEF } from './appFraudEmploymentVerificationDecisionTreeEnglish_def.js';
import tmpl from './appFraudEmploymentVerificationDecisionTreeEnglish.html';
import tmpl_nds from './appFraudEmploymentVerificationDecisionTreeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudEmploymentVerificationDecisionTreeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
