...
import { OMNIDEF } from './appFraudSalaryVerificationDecisionTreeEnglish_def.js';
import tmpl from './appFraudSalaryVerificationDecisionTreeEnglish.html';
import tmpl_nds from './appFraudSalaryVerificationDecisionTreeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudSalaryVerificationDecisionTreeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
