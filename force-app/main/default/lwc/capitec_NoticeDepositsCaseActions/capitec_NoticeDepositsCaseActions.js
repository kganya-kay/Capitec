...
import {caseActionsGetFlagged, postApplyActions, preparePopupsContent, postConfirmHold, fetchConsultantCPByCaseId} from 'c/capitec_NoticeDepositsTHDataHandler'
import LightningAlert from "lightning/alert";
import retailComplaintsModal from 'c/capitec_NoticeDepositsModal';
import {NavigationMixin} from 'lightning/navigation'; //FFSF-428: added to use NavigationMixin

export default class CapitecNoticeDepositsCaseActions extends NavigationMixin(LightningElement) { //FFSF-428: added NavigationMixin to use NavigationMixin.Navigate
