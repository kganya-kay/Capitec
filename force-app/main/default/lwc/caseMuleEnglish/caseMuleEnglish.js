...
import { OMNIDEF } from './caseMuleEnglish_def.js';
import tmpl from './caseMuleEnglish.html';
import tmpl_nds from './caseMuleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseMuleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
