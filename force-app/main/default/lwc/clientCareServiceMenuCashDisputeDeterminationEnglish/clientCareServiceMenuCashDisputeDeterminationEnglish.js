...
import { OMNIDEF } from './clientCareServiceMenuCashDisputeDeterminationEnglish_def.js';
import tmpl from './clientCareServiceMenuCashDisputeDeterminationEnglish.html';
import tmpl_nds from './clientCareServiceMenuCashDisputeDeterminationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clientCareServiceMenuCashDisputeDeterminationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
