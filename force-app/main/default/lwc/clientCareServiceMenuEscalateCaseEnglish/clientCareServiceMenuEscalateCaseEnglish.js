...
import { OMNIDEF } from './clientCareServiceMenuEscalateCaseEnglish_def.js';
import tmpl from './clientCareServiceMenuEscalateCaseEnglish.html';
import tmpl_nds from './clientCareServiceMenuEscalateCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clientCareServiceMenuEscalateCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
