...
import { OMNIDEF } from './caseCaseDetails2English_def.js';
import tmpl from './caseCaseDetails2English.html';
import tmpl_nds from './caseCaseDetails2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCaseDetails2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
