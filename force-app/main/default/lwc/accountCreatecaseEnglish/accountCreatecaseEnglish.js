...
import { OMNIDEF } from './accountCreatecaseEnglish_def.js';
import tmpl from './accountCreatecaseEnglish.html';
import tmpl_nds from './accountCreatecaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountCreatecaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
