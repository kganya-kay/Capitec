...
import { OMNIDEF } from './clientCareServiceMenuRecallRequestEnglish_def.js';
import tmpl from './clientCareServiceMenuRecallRequestEnglish.html';
import tmpl_nds from './clientCareServiceMenuRecallRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clientCareServiceMenuRecallRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
