...
import { OMNIDEF } from './clientCareServiceMenuFraudDeterminationEnglish_def.js';
import tmpl from './clientCareServiceMenuFraudDeterminationEnglish.html';
import tmpl_nds from './clientCareServiceMenuFraudDeterminationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clientCareServiceMenuFraudDeterminationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
