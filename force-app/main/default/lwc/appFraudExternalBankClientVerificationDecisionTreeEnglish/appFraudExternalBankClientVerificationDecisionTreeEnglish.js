...
import { OMNIDEF } from './appFraudExternalBankClientVerificationDecisionTreeEnglish_def.js';
import tmpl from './appFraudExternalBankClientVerificationDecisionTreeEnglish.html';
import tmpl_nds from './appFraudExternalBankClientVerificationDecisionTreeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudExternalBankClientVerificationDecisionTreeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
