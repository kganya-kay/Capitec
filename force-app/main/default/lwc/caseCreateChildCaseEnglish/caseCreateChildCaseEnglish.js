...
import { OMNIDEF } from './caseCreateChildCaseEnglish_def.js';
import tmpl from './caseCreateChildCaseEnglish.html';
import tmpl_nds from './caseCreateChildCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreateChildCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
