...
import { OMNIDEF } from './caseFraudEnglish_def.js';
import tmpl from './caseFraudEnglish.html';
import tmpl_nds from './caseFraudEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseFraudEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
