...
import { OMNIDEF } from './caseCaseInvestigationEnglish_def.js';
import tmpl from './caseCaseInvestigationEnglish.html';
import tmpl_nds from './caseCaseInvestigationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCaseInvestigationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
