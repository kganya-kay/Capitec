...
import { OMNIDEF } from './caseInvestigationChildCaseEnglish_def.js';
import tmpl from './caseInvestigationChildCaseEnglish.html';
import tmpl_nds from './caseInvestigationChildCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseInvestigationChildCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
