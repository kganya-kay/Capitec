...
import { OMNIDEF } from './clientCareHomePageCashDisputeNonClientEnglish_def.js';
import tmpl from './clientCareHomePageCashDisputeNonClientEnglish.html';
import tmpl_nds from './clientCareHomePageCashDisputeNonClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clientCareHomePageCashDisputeNonClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
