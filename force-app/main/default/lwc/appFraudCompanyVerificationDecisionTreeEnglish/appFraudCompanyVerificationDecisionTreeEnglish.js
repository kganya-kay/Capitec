...
import { OMNIDEF } from './appFraudCompanyVerificationDecisionTreeEnglish_def.js';
import tmpl from './appFraudCompanyVerificationDecisionTreeEnglish.html';
import tmpl_nds from './appFraudCompanyVerificationDecisionTreeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class appFraudCompanyVerificationDecisionTreeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
